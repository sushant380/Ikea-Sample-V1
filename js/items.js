...
$(document).ready(function() {
  itemsData = [
   /*{
    ...
    {
      "name" : "IKEA.Host.Basecabinet_36_inch_sink",
      "image" : "models/thumbnails/wooden_cabinet_texture_by_the_auteur_stock.jpg",
      "type" : "10",
      "model" : "models/js/50215475.js",
    },
   {
      "name" : "Hob",
      "image" : "models/thumbnails/wooden_cabinet_texture_by_the_auteur_stock.jpg",
      "type" : "2",
      "model" : "models/js/hob.js",
    },
    {
      "name" : "Hob",
      "image" : "models/thumbnails/wooden_cabinet_texture_by_the_auteur_stock.jpg",
      "type" : "2",
      "model" : "models/js/00205431.json",
    }
